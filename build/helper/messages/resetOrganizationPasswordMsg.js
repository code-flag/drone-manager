        ...
        <tbody>
            ...
            <tr style="height: 300px;">
                <td align="left" style="border: none;
                    ...
                    <br><br>
                    <a href="organization.payslate.com.ng/reset-password-account/${data.token}" style="background-color: #026395; color: #fff; padding: 10px 20px; cursor: pointer; text-decoration: none">Confirm Email</a>
                    
                    <br><br>
                    If the button does not work, click on the link below or copy the link to a browser tab and run it.
                    <br> https://organization.payslate.com.ng/reset-password-account/${data.token}
                    </p>
...
exports.resetOrganizationPasswordMsg = resetOrganizationPasswordMsg;
