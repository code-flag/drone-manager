...
const BucketFolder_1 = `${process.env.AWS_S3_BUCKET}/pay-slate/profile-pic`;
const BucketFolder_2 = `${process.env.AWS_S3_BUCKET}/pay-slate/kyc-documents`;
const BucketFolder_3 = `${process.env.AWS_S3_BUCKET}/pay-slate/dispute-pop`;
...
export const uploadBigKYCDocument = multer({
    storage: multerS3({
        s3: s3,
        acl: "public-read",
        contentType: multerS3.AUTO_CONTENT_TYPE,
...
export const disputeFileUpload = multer({
    storage: multerS3({
        s3: s3,
        acl: "public-read",
        contentType: multerS3.AUTO_CONTENT_TYPE,
