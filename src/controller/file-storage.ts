...
const BucketFolder_1 = `${process.env.AWS_S3_BUCKET}/bank_account_manager/profile-pic`;
const BucketFolder_2 = `${process.env.AWS_S3_BUCKET}/bank_account_manager/kyc-documents`;
